    ...
    async fn get_evidence(&self, mut report_data: Vec<u8>) -> Result<TeeEvidence> {
        ...
        let (report, certs): (Vec<u8>, Option<Vec<CertTableEntry>>) =
            TsmReportPath::new(TsmReportProvider::Sev).map_or_else(
                |e| {
                    warn!("TSM Report not supported. Attestation report data will be obtained via the sev Rust crate instead. Reason: {}", e);
                ...
                |_tsm|{
                    ...
                    let tsm_report_path: TsmReportPath = TsmReportPath::new(TsmReportProvider::Sev)
                    ...
                    let report: Vec<u8> = tsm_report_path
                        .privlevel(VMPrivilegeLevel::default())?
                    ...
                    let certs = match cert_table_data.is_empty() {
                        ...
                        false => {
                            ...
                            trace!("Certificate table data: {:?}", cert_table_data);
